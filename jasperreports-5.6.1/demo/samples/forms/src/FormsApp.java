 ...
 * @version $Id: FormsApp.java 7199 2014-08-27 13:58:10Z teodord $
 */
public class FormsApp extends AbstractSampleApp
{
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.printReport("build/reports/FormsReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToHtmlFile("build/reports/FormsReport.jrprint");
