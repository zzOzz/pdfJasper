 ...
 * @version $Id: StylesApp.java 7199 2014-08-27 13:58:10Z teodord $
 */
public class StylesApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		JasperFillManager.fillReportToFile("build/reports/StylesReport.jasper", null);
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.printReport("build/reports/StylesReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/StylesReport.jrprint", false);
