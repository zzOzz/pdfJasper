 ...
 * @version $Id: RotationApp.java 7199 2014-08-27 13:58:10Z teodord $
 */
public class RotationApp extends AbstractSampleApp
{
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.printReport("build/reports/RotationReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("build/reports/RotationReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/RotationReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/RotationReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
