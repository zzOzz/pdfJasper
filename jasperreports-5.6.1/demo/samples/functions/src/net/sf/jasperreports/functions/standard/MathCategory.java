 ...
 * @version $Id: MathCategory.java 7199 2014-08-27 13:58:10Z teodord $
 */
@FunctionCategory(
	//"MATH" // if not specified, the value is the name of the category class
	)
public final class MathCategory 
{
}
