 ...
 * @version $Id: StretchApp.java 7199 2014-08-27 13:58:10Z teodord $
 */
public class StretchApp extends AbstractSampleApp
{
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.printReport("build/reports/StretchReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("build/reports/StretchReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/StretchReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/StretchReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToHtmlFile("build/reports/StretchReport.jrprint");
