 ...
 * @version $Id: UnicodeApp.java 7199 2014-08-27 13:58:10Z teodord $
 */
public class UnicodeApp extends AbstractSampleApp
{
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("build/reports/UnicodeReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/UnicodeReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	public void xhtml() throws JRException
	{
		...
		exporter.setExporterInput(new SimpleExporterInput(jasperPrint));
		exporter.setExporterOutput(new SimpleHtmlExporterOutput(destFile, "UTF-8"));
