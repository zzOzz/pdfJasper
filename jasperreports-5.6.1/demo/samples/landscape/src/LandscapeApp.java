 ...
 * @version $Id: LandscapeApp.java 7199 2014-08-27 13:58:10Z teodord $
 */
public class LandscapeApp extends AbstractSampleApp
{
	...
	{
		long start = System.currentTimeMillis();
		//JasperPrintManager.printReport("build/reports/LandscapeReport.jrprint", true);
		JasperPrintManager.printReport("build/reports/LandscapeReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("build/reports/LandscapeReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/LandscapeReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
